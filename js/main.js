...
var DIVISIONS = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=1000&q=70',
    groups: [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1568992688065-536aad8a12f6?auto=format&fit=crop&w=1000&q=70',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1533750349088-cd871a92f312?auto=format&fit=crop&w=1000&q=70',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?auto=format&fit=crop&w=1000&q=70',
...
function renderDetail(divIndex) {
  ...
  var html = '<img class="detail-image" src="' + div.image + '" alt="' + div.title + '">';
  html += '<div class="detail-header"><span class="detail-badge">División ' + pad2(divIndex + 1) + '</span><h3>' + div.title + '</h3></div>';
...
function updateSummary() {
  ...
  if (summaryCta) {
    ...
    var mailto = 'mailto:Info@grupoberlahn.com?subject=' + encodeURIComponent(subject) + '&body=' + encodeURIComponent(bodyLines.join('\n'));
...
if (contactForm) {
  contactForm.addEventListener('submit', function (e) {
    ...
    window.location.href = 'mailto:Info@grupoberlahn.com?subject=' + encodeURIComponent(subject) + '&body=' + encodeURIComponent(lines.join('\n'));
  });
}
